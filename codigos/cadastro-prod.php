...
<?php
	...
	<div id="formulario">
	<form name="form" action="resultado.php" method="post" onsubmit="return validarSenha(this)">
		<fieldset>
		...
		<div class="campo">
                ...
                <input type="password" id="email" name="senha" style="width: 10em" value="">
				 </div><div class="campo">
				<label for="cidade">Confirmar senha</label>
                <input type="password" id="email" name="senha1" style="width: 10em" value="">
            </div>
		</fieldset>
          <div class="campo">
        ...
        <button type="submit" class="botao submit" name="submit">Cadastrar</button></fieldset>
		</div>
	</form>
	</div>
</main>
