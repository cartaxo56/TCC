...
<html>
<head>
	<title>Excluído - Geek Club</title>
	<meta charset='utf-8'>
...
?></div><?php
	...
	<div id="conta">
		<?php
						...
						mysqli_query($link,$deleta);
						?>
						<center><h1> Produto excluido com sucesso!</h1><br><br><h3>Click <a href="produtos.php">Aqui</a> para voltar.</h3><center><br><br><br>
	</div>
	</main>
	</div>
