...
<div id="fundo">
	...
	$busca=$_POST['palavra'];
	if (!$busca){
		echo "<H1><br>Não encontramos nenhum resultado para a sua busca!<br><br></H1>";
		echo "<img src='choro.png' id='choro'>";
	}else{
		...
		while($resul = mysqli_fetch_array($resultado)){
			...
			echo "<table id='admin'><tr><td><a href='atualiza.php?id=".$resul['id']."' id='btncompra' >Atualizar</a></td><td><a href='deleta.php?id=".$resul['id']."' id='btncompra' >Deletar</a></td></tr></table></div></div><br>";
