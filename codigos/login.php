...
<?php
	...
	<p id="textlogin">ENTRE AGORA</p>
	<p id="textcadastro">NÃO TEM CADASTRO?</p>
	<div id="formulario">
	<form class="login" action="validar.php" method="post" style="margin-bottom: 0">
		<fieldset id="linha">
		...
		<div class="campo">
                ...
                <input type="password" id="snome" name="senha" style="width: 10em" value="">
            </div>
		</fieldset>
		<button type="submit" class="botao2" name="submit">Entrar</button>
		</fieldset>
	</form>
	</div>
	<a href="cadastro.php"> <button type="submit" class="botao3" name="submit">Cadastre-se</button> </a>
</main>
