...
$atualizar="UPDATE produtos SET nome = '$nomeprod', descricao = '$descricao', preco = '$preco', tipo_imagem = '$tipo', nome_imagem = '$nome', tamanho_imagem = '$tamanho' WHERE id = '$id'";
...
?>
	...
	<div id="fundo">
	<main><div id="conta">
	<center><h1> Produto atualizado com sucesso!</h1><br><br><h3>Click <a href="produtos.php">Aqui</a> para voltar.</h3><center><br><br><br>
	</div>
</main>
	</div>
