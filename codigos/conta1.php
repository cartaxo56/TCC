...
if($codigo=="GC2018"){
$nivel=2;
$atualizar = "UPDATE cliente SET Nome = '$nome', Sobrenome = '$sobrenome', Telefone = '$telefone',Sexo = '$sexo', Endereco = '$endereco', NumeroCasa = '$logradouro', Cidade = '$cidade', Estado = '$estado',email = '$email', nivel = '$nivel' WHERE cliente.CPF = '$cpf'";

$result = mysqli_query($link,$atualizar);
...
?><html>
<head>
	<title>Minha conta - Geek Club</title>
	<meta charset='utf-8'>
...
$nome = $resul['Nome'];
$sobrenome = $resul['Sobrenome'];
$telefone = $resul['Telefone'];
$sexo = $resul['Sexo'];
$endereco = $resul['Endereco'];
$logradouro = $resul['NumeroCasa'];
$cidade = $resul['Cidade'];
$estado = $resul['Estado'];
}
echo"Nome Completo:$nome $sobrenome</br>
					...
					Estado: $estado</br>
					Email: $email</br>";
				echo"</br></br><a class='botao submit' href='atualizar.php'>Atualizar Cadastro</a></br></br>";
