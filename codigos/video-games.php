...
<body>
	<header>
		...
		<tr><td><input type="text" id="texto" list="historico" placeholder="Buscar..."/></td>
...
<div id="fundo">
	...
	<?php
		$sql="SELECT * FROM produtos WHERE categoria = 4 && subcategoria = 11"; 
...
?>
	...
	<div id="rodape">
		<h3>CONTATO:</h3>
	<br>
		<i class="material-icons">call</i><h2>(11) 3677-4000</h2>
	<br>
		<i class="material-icons">mail</i><h2>contato@geekclub.gmail.com</h2>
	</div>
