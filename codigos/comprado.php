...
$inserir = "insert into compra (id,idp,idc,numerocartao,datavalidade,codigoseguranca,pagamento) VALUES (id,'$idp','$idc','$numerocartao','$datavalidade','$codigoseguranca','$pagamento')";
mysqli_query($link,$inserir);
echo '<script>alert("Solicitação de compra enviada com sucesso, acompanhe o processo da compra através do seu email! XD")</script>';
session_start();
...
<html>
<head>
	<title>Comprado - Geek Club</title>
	<meta charset="utf8">
